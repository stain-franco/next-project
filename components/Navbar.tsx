...
const NavBar = () => {
  return (
    <header className="flex justify-between items-center p-11 bg-backgroud">
      ...
      <button className='inline-flex items-center px-3 py-2 text-[16px] font-medium text-center text-white bg-blue rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue dark:hover:bg-DarkBlue dark:focus:ring-blue-800'>Get started</button>
    </header>
  );
}
