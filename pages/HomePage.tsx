...
const HomePage: NextPageWithLayout = () => {
  return (
    <div className="flex justify-center bg-#E6ECF5">
      <div className="max-w-sm p-6">
        ...
        <p>
          ...
          start to ﬁnish, ensuring you have the insight and knowledge needed to
          succeed.
        </p>
      </div>
...
HomePage.getLayout = function getLayout(HomePage: ReactElement) {
  return <LayaoutFooter>{HomePage}</LayaoutFooter>;
};
