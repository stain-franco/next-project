...
const index: NextPageWithLayout = () => {
  return (
    ...
    <div className="bg-backgroud absolute"><h1  className="text-3xl font-Nunito font-bold sm:left-[96px] left-[32px] absolute sm:top-[38px] top-[23px]">resimex</h1></div>
      <div className="bg-backgroud  flex flex-wrap justify-center">
        ...
        <div className="bg-Grey h-[329px] w-full  z-0 top-[871px] absolute">
          ...
          <div className='sm:w-[237px] sm:h-[237px] rounded-full bg-white sm:bottom-[80px] absolute z-30 sm:left-[972px] hidden sm:block'>
            <h3 className='text-blue font-Inter text-justify text-3xl top-[90px] absolute left-[77px]' >Say,<br></br>Hello!</h3>
