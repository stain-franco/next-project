  ...
  return (
    <div className='bg-backgroud'>
     ...
     <div className='flex justify-center'>
          ...
          <h1 className='text-[41.45px] font-medium leading-[56.54px] w-[89px] h-[57px] sm:hidden rotate-[24.93deg]  mt-[56.17px]'>Let’s</h1>
          <h1 className='text-[41.45px] font-medium leading-[84.57px] w-[96px] h-[57px] sm:hidden rotate-[-14.8deg] mt-[56.17px]'>do it</h1>
          <h1 className='text-[41.45px] font-medium leading-[84.57px] w-[184px] h-[57px] sm:hidden rotate-[19.23deg]  mt-[56.17px]'>together!</h1>
          </div>
     ...
     <main className="bg-backgroud sm:bg-[url('/images/Group.png')] 
      ...
      <div className="bg-Ligthgray pt-[94px]  pb-[113px]">
        ...
        <div className="sm:flex sm:justify-center sm:items-center sm:gap-5">
          <div className="sm:w-[241px] sm:h-[219px] sm:p-6 bg-white border border-gray-200 rounded-[10px]">
            <h1 className="font-bold text-DarkBlue sm:mb-[18px] sm:text-[20px] sm:w-[200px] sm:h-[22px] sm:text-center">Speed and Simplicity</h1>
            <div className='sm:w-[190px] sm:h-[100px] sm:font-light sm:text-center'>
          ...
          <div className="sm:w-[241px] sm:h-[219px] sm:p-6 bg-white border border-gray-200 rounded-[10px]">
            <h1 className="font-bold text-DarkBlue pb-[18px] sm:text-center">Awesome support</h1>
            <div className='sm:w-[190px] sm:h-[120px] sm:font-light sm:text-center'>
